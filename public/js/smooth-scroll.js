(function() {
	...
	if ( 'querySelector' in document && 'addEventListener' in window && Array.prototype.forEach ) {
		...
		var smoothScrollClass = function (anchor, duration, easing) {
		...
		var scrollToggleApply = document.querySelectorAll('.scroll');
		[].forEach.call(scrollToggleApply, function (toggle) {
			...
			toggle.addEventListener('click', function(e) {
				...
				if (dataTarget) {
					...
					smoothScrollClass(dataTarget, dataSpeed || 1200, dataEasing || 'easeInOutCubic');
				}
